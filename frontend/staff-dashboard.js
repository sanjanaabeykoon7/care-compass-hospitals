document.addEventListener("DOMContentLoaded", function () {
    ...
    /**
     * Fetch and Populate Appointment Management Section
     */
    ...
    /**
     * Fetch and Populate Medical Records Section
     */
    ...
    document.getElementById("logoutButton").addEventListener("click", () => {
        fetch('../backend/routes/logout.php', {
            method: 'POST', // Use POST to ensure session is properly destroyed
        })
            .then((response) => response.json())
            .then((data) => {
                if (data.success) {
